...
class MANM(nn.Module):
    def __init__(
        ...
        self.hooks = False
    path="C:\\Users\\viksp\\Documents\\Folder_of_Folders\\Polygence_code\\calling-out-bluff-models_test\\Model5MemoryNetsPytorch\\results"
    def forward(
    ...
    def save_weights(self,path1):
        with open(path1, "wb+") as f:
            torch.save(self.state_dict(), f)

    def load_weights(self,path1):
